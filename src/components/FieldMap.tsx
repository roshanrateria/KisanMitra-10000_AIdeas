...
import { MapPin, Plus, Trash2, Edit3, Navigation } from 'lucide-react';
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Crop: {field.crop} | Area: {field.area} acres
                  </p>
                </div>
              </div>
            </div>
      ...
      {drawnCoordinates.length > 0 && (
        <div className="space-y-3 p-4 bg-muted rounded-lg">
          ...
          <Button 
            ...
            className="w-full"
            disabled={!fieldName || !crop}
          >
            <Plus className="w-4 h-4 mr-2" />
            <TranslatedText text="Add Field" targetLanguage={language} />
          </Button>
        </div>
      )}
    </Card>
