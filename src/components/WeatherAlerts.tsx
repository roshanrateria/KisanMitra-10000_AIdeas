...
const generateWeatherAlerts = (weather: WeatherData | null): WeatherAlert[] => {
  ...
  if (weather.temp > 40) {
    alerts.push({
      ...
      description: `Temperature ${weather.temp}°C. High risk of heat stress to crops.`,
      icon: Sun,
    ...
    alerts.push({
      ...
      description: `Temperature ${weather.temp}°C. Monitor crops for heat stress.`,
      icon: Sun,
  ...
  if (weather.temp < 10) {
    alerts.push({
      ...
      description: `Temperature ${weather.temp}°C. Risk of frost damage.`,
      icon: Snowflake,
  ...
  if (weather.wind_speed > 25) {
    alerts.push({
      ...
      description: `Wind speed ${weather.wind_speed} km/h. Risk of crop lodging.`,
      icon: Wind,
    ...
    alerts.push({
      ...
      description: `Wind speed ${weather.wind_speed} km/h.`,
      icon: Wind,
  ...
  if (weather.humidity > 85) {
    alerts.push({
      ...
      description: `Humidity ${weather.humidity}%. Increased disease risk.`,
      icon: CloudRain,
  ...
  if (rainProbability > 0.7 && weather.clouds > 70) {
    alerts.push({
      type: 'info',
      title: 'Rain Expected',
