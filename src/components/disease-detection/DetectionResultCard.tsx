    ...
    <Card className="w-full shadow-sm hover:shadow-md transition-shadow duration-200">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          ...
          <Badge
            ...
            className={`text-base font-semibold px-3 py-1 ${!hasDetections ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100' : ''}`}
          >
            {hasDetections ? (
              <TranslatedText
      ...
      <CardContent className="space-y-4">
        {hasDetections ? (
            ...
            <div className="space-y-3">
              {result.predictions.map((prediction, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="p-4 rounded-lg border border-border bg-muted/30 hover:bg-muted/50 transition-colors duration-200"
                  >
          ...
          <div className="flex items-start gap-3 p-6 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-900">
